...
export default function SponsorDialog({ open, onClose }: Props) {
  ...
  const validate = () => {
    ...
    if (!form.company_website) newErrors.company_website = "Company website is required";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-2xl mx-4 
        ...
        <div className="grid grid-cols-1 gap-5">
          ...
          <Input label="Company Name" name="company" form={form} setForm={setForm} error={errors.company} />
          <Input label="Company Website" name="company_website" form={form} setForm={setForm} error={errors.company_website} />
        </div>
